...
export default function Settings() {
  ...
  return (
    <div className="min-h-screen p-10 bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <motion.div className="bg-white p-6 rounded-2xl shadow-md space-y-4" whileHover={{ scale: 1.02 }}>
        <div>
        ...
        <div className="flex items-center gap-3">
          <input type="checkbox" name="autoUpdates" checked={settings.autoUpdates} onChange={handleChange} />
